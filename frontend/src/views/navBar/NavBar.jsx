...
const NavBar = () => {
  return (
    <nav
      className="capitalize flex justify-between p-3 static w-screen max-w-full md:p-0 md:static md:flex bg-[#B4FFED] border-white"
      onClick={() => {
    ...
    >
      <div className="menu hidden flex-col justify-center absolute left-0 mt-9 md:m-0  w-1/2 h-screen z-10 bg-teal-600 pt-40 pl-7 md:bg-[#B4FFED] md:static md:h-full md:flex md:flex-row md:justify-around md:w-full md:p-0">
